  ...
  return (
    ...
    >
      ...
      <div className="min-w-0">
        <SafeLink
          href={profileHref}
          className={`block truncate text-[16px] focus-visible:outline-none after:absolute after:inset-0 after:content-[''] ${current ? "font-semibold" : "font-medium"} ${muted ? "text-ink-2" : "text-ink"}`}
        >
          {a.patient.name}
        </SafeLink>
        <p className="mt-0.5 line-clamp-2 text-[14px] text-ink-3">{a.reason}</p>
      </div>
