...
export function NotesPanel({
  ...
  return (
    <section
      ...
      className="panel flex min-h-[60dvh] flex-col md:min-h-[420px] transition-shadow duration-200 focus-within:shadow-2 xl:h-full xl:min-h-0"
    >
      ...
      <textarea
        ...
        className="min-h-0 flex-1 resize-none bg-transparent px-6 py-2 text-[15px] leading-[1.75] text-ink placeholder:text-ink-4"
      />
